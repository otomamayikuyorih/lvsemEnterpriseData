...
- 最も大きい有意パスは `POS_to_JS` (β=0.626, p≈0.000) でした。
- 5%水準で有意だったパス: `POS_to_JS` (β=0.626), `POS_to_WLB` (β=0.525), `POS_to_ITS` (β=0.478), `WLB_to_ITS` (β=0.280), `JS_to_ITS` (β=0.139)。
- 有意でなかったパス: なし。
- 説明力が最も高い内生構成概念は `ITS` (R2=0.603) です。
