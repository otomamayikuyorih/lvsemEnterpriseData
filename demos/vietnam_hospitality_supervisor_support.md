...
上司支援から職務満足と組織コミットメントへの関係は強く、上司の支えが従業員態度に深く関係していることが分かります。 職務パフォーマンスに対しては、上司支援や職務満足の直接的な関係よりも、組織コミットメントの寄与が相対的に重要に見えます。 つまり、このデータでは、上司支援がすぐにパフォーマンスへ効くというより、 職務満足や組織への結びつきを通じて職務行動に波及する構図として読むと自然です。 サービス業の社内マネジメント改善を考えるデモとして有用です。
