...
- 最も大きい有意パスは `NC_to_OCB` (β=0.425, p≈0.000) でした。
- 5%水準で有意だったパス: `NC_to_OCB` (β=0.425), `AC_to_JP` (β=0.347), `OCB_to_JP` (β=0.330), `CC_to_OCB` (β=0.278), `CC_to_JP` (β=0.184), `NC_to_JP` (β=0.154)。
- 有意でなかったパス: `AC_to_OCB`。
- 説明力が最も高い内生構成概念は `JP` (R2=0.732) です。
